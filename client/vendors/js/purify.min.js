...
!(function (e, t) {
    ...
    return (function e() {
        ...
        var oe = V(Z, r),
            ...
            me = {};
        try {
            me = S(o).documentMode ? o.documentMode : {};
        } catch (e) {}
        var de = {};
        n.isSupported = "function" == typeof ne && le && void 0 !== le.createHTMLDocument && 9 !== me;
        var pe = z,
            ge = H,
            he = U,
            ye = j,
            ...
            Te = P,
            Ae = null,
            xe = w({}, [].concat(q(R), q(_), q(D), q(N), q(L))),
            we = null,
            Se = w({}, [].concat(q(M), q(F), q(C), q(I))),
            ke = null,
            Re = null,
            _e = !0,
            De = !0,
            ...
            We = null,
            Ge = w({}, ["audio", "video", "img", "source", "image", "track"]),
            qe = null,
            Ke = w({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "summary", "title", "value", "style", "xmlns"]),
            Ve = null,
            ...
            Xe = function (e) {
                (Ve && Ve === e) ||
                    ...
                    (e = S(e)),
                    (Ae = "ALLOWED_TAGS" in e ? w({}, e.ALLOWED_TAGS) : xe),
                    (we = "ALLOWED_ATTR" in e ? w({}, e.ALLOWED_ATTR) : Se),
                    (qe = "ADD_URI_SAFE_ATTR" in e ? w(S(Ke), e.ADD_URI_SAFE_ATTR) : Ke),
                    (We = "ADD_DATA_URI_TAGS" in e ? w(S(Ge), e.ADD_DATA_URI_TAGS) : Ge),
                    (ke = "FORBID_TAGS" in e ? w({}, e.FORBID_TAGS) : {}),
                    (Re = "FORBID_ATTR" in e ? w({}, e.FORBID_ATTR) : {}),
                    ...
                    Pe &&
                        ((Ae = w({}, [].concat(q(L)))),
                        (we = []),
                        !0 === Pe.html && (w(Ae, R), w(we, M)),
                        !0 === Pe.svg && (w(Ae, _), w(we, F), w(we, I)),
                        !0 === Pe.svgFilters && (w(Ae, D), w(we, F), w(we, I)),
                        !0 === Pe.mathMl && (w(Ae, N), w(we, C), w(we, I))),
                    e.ADD_TAGS && (Ae === xe && (Ae = S(Ae)), w(Ae, e.ADD_TAGS)),
                    e.ADD_ATTR && (we === Se && (we = S(we)), w(we, e.ADD_ATTR)),
                    e.ADD_URI_SAFE_ATTR && w(qe, e.ADD_URI_SAFE_ATTR),
                    Ue && (Ae["#text"] = !0),
                    Oe && w(Ae, ["html", "head", "body"]),
                    Ae.table && (w(Ae, ["tbody"]), delete ke.tbody),
                    i && i(e),
                    (Ve = e));
            },
            $e = w({}, ["mi", "mo", "mn", "ms", "mtext"]),
            Ze = w({}, ["foreignobject", "desc", "title", "annotation-xml"]),
            Je = w({}, _);
        w(Je, D), w(Je, E);
        var Qe = w({}, N);
        w(Qe, O);
        var et = "http://www.w3.org/1998/Math/MathML",
            ...
            rt = function (e) {
                ...
                if (e.namespaceURI === tt)
                    return t.namespaceURI === nt ? "svg" === n : t.namespaceURI === et ? "svg" === n && ("annotation-xml" === r || $e[r]) : Boolean(Je[n]);
                if (e.namespaceURI === et) return t.namespaceURI === nt ? "math" === n : t.namespaceURI === tt ? "math" === n && Ze[r] : Boolean(Qe[n]);
                if (e.namespaceURI === nt) {
                    if (t.namespaceURI === tt && !Ze[r]) return !1;
                    if (t.namespaceURI === et && !$e[r]) return !1;
            ...
            at = function (e) {
                ...
                return e && n && t.body.insertBefore(o.createTextNode(n), t.body.childNodes[0] || null), se.call(t, Oe ? "html" : "body")[0];
            },
            lt = function (e) {
                return ce.call(
                    e.ownerDocument || e,
            ...
            st = function (e) {
                return "object" === (void 0 === c ? "undefined" : G(c))
                    ? e instanceof c
                    : e && "object" === (void 0 === e ? "undefined" : G(e)) && "number" == typeof e.nodeType && "string" == typeof e.nodeName;
            },
            ut = function (e, t, r) {
                de[e] &&
                    m(de[e], function (e) {
            ...
            ft = function (e) {
                ...
                if (
                    ...
                    !st(e.firstElementChild) && (!st(e.content) || !st(e.content.firstElementChild)) && T(/<[/\w]/g, e.innerHTML) && T(/<[/\w]/g, e.textContent))
                )
                    return ot(e), !0;
                if (!Ae[r] || ke[r]) {
                    if (Ue && !Be[r]) {
            ...
            mt = function (e, t, n) {
                if (He && ("id" === t || "name" === t) && (n in o || n in Ye)) return !1;
                if (De && T(he, t));
                else if (_e && T(ye, t));
                else {
            ...
            dt = function (e) {
                ...
                var a = e.attributes;
                if (a) {
                    var l = { attrName: "", attrValue: "", keepAttr: !0, allowedAttributes: we };
                    for (i = a.length; i--; ) {
                        var c = (t = a[i]),
                            s = c.name,
                            u = c.namespaceURI;
            ...
            pt = function e(t) {
                ...
                for (ut("beforeSanitizeShadowDOM", t, null); (n = r.nextNode()); )
                    ut("uponSanitizeShadowNode", n, null), ft(n) || (n.content instanceof a && e(n.content), dt(n));
        ...
        return (
            (n.sanitize = function (e, o) {
                var i = void 0,
                    ...
                    u = void 0,
                    f = void 0;
                if ((e || (e = "\x3c!--\x3e"), "string" != typeof e && !st(e))) {
                ...
                if (!n.isSupported) {
                    if ("object" === G(t.toStaticHTML) || "function" == typeof t.toStaticHTML) {
                        ...
                        if (st(e)) return t.toStaticHTML(e.outerHTML);
                    }
                    return e;
                }
                if ((Le || Xe(o), (n.removed = []), "string" == typeof e && (je = !1), je));
                else if (e instanceof c)
                    (1 === (l = (i = at("\x3c!----\x3e")).ownerDocument.importNode(e, !0)).nodeType && "BODY" === l.nodeName) || "HTML" === l.nodeName
                        ? (i = l)
                        : i.appendChild(l);
                else {
                    if (!Fe && !Ne && !Oe && -1 === e.indexOf("<")) return oe && ze ? oe.createHTML(e) : e;
                    if (!(i = at(e))) return Fe ? null : ie;
                }
                i && Me && ot(i.firstChild);
                for (var m = lt(je ? e : i); (s = m.nextNode()); ) (3 === s.nodeType && s === u) || ft(s) || (s.content instanceof a && pt(s.content), dt(s), (u = s));
                if (((u = null), je)) return e;
                if (Fe) {
                    if (Ce) for (f = ue.call(i.ownerDocument); i.firstChild; ) f.appendChild(i.firstChild);
                    else f = i;
                    return Ie && (f = fe.call(r, f, !0)), f;
                }
                var d = Oe ? i.outerHTML : i.innerHTML;
                return Ne && ((d = y(d, pe, " ")), (d = y(d, ge, " "))), oe && ze ? oe.createHTML(d) : d;
            }),
